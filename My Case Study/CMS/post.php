...
<?php
    ...
    if(isset($_GET['p_id']))
    {
      ...
      $post_views_count_query = mysqli_query($connection, $view_query);
    ...
    {
        $query = "SELECT * FROM posts WHERE post_id = $the_post_id AND post_status = 'published' ORDER BY post_id DESC ";                      
    } 
...
<!-- <small>Secondary Text</small>-->
        ...
        <!-- First Blog Post -->
        <h2>
            <a href="/cms/index.php"><?php echo $post_title ?></a>
        </h2>
...
?>
        <p class="lead">
            by <a href="/cms/author_post.php?author_id=<?php echo $user_id ?>&p_id=<?php echo $the_post_id ?>"><?php echo $username ?></a>
        </p>
...
?>
        ...
        <div class="well">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
            <textarea class="form-control" name="comment_content" id="body_contact" cols="50" rows="10"></textarea>
           </div>
<!--
            <div class="form-group">
                <textarea id="body" name="comment_content" class="form-control" rows="3"></textarea>
            </div>
-->
