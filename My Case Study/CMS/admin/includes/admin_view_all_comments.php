...
//    }
    ...
    echo "<td><a href='admin_comments.php?upapprove=$comment_id'>Unapprove</a></td>";
        
    echo "<td><a href='admin_posts.php?delete='>Edit</a></td>";   
    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to detele'); \" href='admin_comments.php?delete=$comment_id'>Delete</a></td>";   
    echo "</tr>";
